...
- [旋转方阵](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/RotateMatrix.java)

- [“之”字形打印矩阵](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/ZigZagPrintMatrix.java)

- [在行列都排好序的矩阵中找数](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/FindNumInSortedMatrix.java)

#### 链表

- [反转单向和双向链表](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/ReverseList.java)

- [打印两个有序链表公共部分](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/PrintCommonPart.java)

- [判断是否是回文链表](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/IsPalindromeList.java)

- [将单向链表按某值划分成左边小、中间相等、右边大的形式](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/SmallerEqualBigger.java)

- [复制含有随机指针节点的链表](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/CopyListWithRandom.java)

- [寻找两个单链表的交点](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/FindFirstIntersectNode.java)

- [合并k个有序链表](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/MergeKLists.java)

#### 栈和队列

- [用数组实现栈和队列](https://github.com/A11Might/SomeCodeByMyself/blob/master/learningCode/ArrayToStackQueue.java)

- [使用队列实现栈和使用栈实现队列](https://github.com/A11Might/SomeCodeByMyself/blob/master/learningCode/StackAndQueueConvert.java)
...
- [打印二叉树](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/PrintTree.java)

- [实现二叉树的先序、中序、后序遍历](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/PreInPosTraversal.java)

- [在二叉树中找到一个节点的后继节点](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/SuccessorNode.java)

- [在二叉树中找到一个节点的前驱节点](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/PrecurorNode.java)

- [二叉树的序列化和反序列化](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/SerializeAndReconstructTree.java)

- [折纸问题](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/PaperFolding.java)

- [求完全二叉树节点个数](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/CompleteTreeNodeNumber.java)

- [判断一棵二叉树是否是平衡二叉树](https://github.com/A11Might/SomePracticeCode/blob/master/learningCode/IsBalancedTree.java)
